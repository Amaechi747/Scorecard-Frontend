            ...
            <Card2>
                ...
                <ProfileImage>
                    <div>
                        ...
                        : 
                            <img src="/assets/images/loginPageImage.png" alt="profile" style={{width: '10rem', height: '10rem', objectFit: 'cover', clipPath: 'circle(50%)'}} />
                        }
                        <button onClick={handleImageButtonClick}>
                            <FaPencilAlt style={{fontSize: '1rem', color: '#fff'}}/>
                        </button>
                        <input type="file" name="email" id="" style={{display: 'none'}} ref={imageRef}/>
                    </div>
                </ProfileImage>
                <Form onSubmit={() => {}} >
                    <FormInput2 
